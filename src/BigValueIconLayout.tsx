...
export abstract class BigValueIconLayout {
...
export class WideNoChartLayout extends BigValueIconLayout {
...
export class WideWithChartLayout extends BigValueIconLayout {
  constructor(props: Props) {
    super(props);
...
export class StackedWithChartLayout extends BigValueIconLayout {
  constructor(props: Props) {
    super(props);
...
export class StackedWithNoChartLayout extends BigValueIconLayout {
  constructor(props: Props) {
    super(props);
...
export function buildLayout(props: Props): BigValueIconLayout {
